            ...
            <div>
                ...
                <div style={{display:'flex', flexDirection:'row', alignItems:'center'}}>
                    <div class="form-about">
                        <div style={{display:'flex', flexDirection:'column', flex:1}}>
                            ...
                            <div class="definition" data-aos="fade-up" data-aos-delay="500">
                                <h3 class="text" style={{marginLeft:'12%', marginRight:'12%'}}>
                                    ...
                                    gases as shown on the chart, the largest of these is the transportation sector, accounting for 29% of all carbon
                        ...
                        <div style={{display:'flex', flexDirection:'row',flex:1,alignItems:'center' }} data-aos="zoom-in" data-aos-delay="400">
                            <Image src={Chart} style={{width:'100%'}}/>
                        </div>
                    </div>
                </div>
            </div>
